...
/** 
  Modified by Reini Grauer
  https://github.com/SwissPatriotRG/Fadal
  Fixed spindle speed decimal issue 
  Added tool positive gauge length adjustment
*/

description = "Advanced Fadal";
vendor = "Fadal";
